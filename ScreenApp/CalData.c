...
static SystemCalDataType localCalData =
{
   .scaleCalibrationData = 
   {
      ...
      .frontZero = 0.0,
      .backZero  = 0.0,
      .frontAtCal = 1000.0, // made up
      .backAtCal =  1000.0, // made up
      .frontSlope = 1.0,  // made up
      .backSlope = 1.0,   // made up
      .calWeight = 62.04, // made up
      .WingPegDist = 119.8, // some nominal value
      .LEstopperDist = 30.0 // some nominal value
   }
};
/**
